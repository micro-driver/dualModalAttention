...
PRETAINED_WEIGHT_PATH = 'E:\PythonProject\dualModalAttention\src\\networks\\xception-b5690688.pth'
...
class TransferModel(nn.Module):
    ...
    def __init__(self, modelchoice, num_out_classes=2, dropout=0.0,
        ...
        if modelchoice == 'xception':
            ...
            # model_children = [x for x in self.model.named_children()]
...
if __name__ == '__main__':
    ...
    # model_children = [x for x in model.named_children()]
    # print(model_children)
    # print(model)
    # model = model.cuda()
